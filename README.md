...
Every question lives in its directory:

- `labSetUp.sh`  set up the environment.
- `questions.txt`  the scenario description and tasks
- `solutions.txt`  a step-by-step solution for a task.
